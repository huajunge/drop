...
public class Italy extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
       ...
       ListView    listView = (ListView) findViewById(R.id.listView_Italy);
        ...
        final String url = Liveurl+"search/search_results?location=United%20States";
...
//*******************************************ListView code start*****************************************************
	...
	{
		Intent back=new Intent(Italy.this,Swipe_tabs.class);
