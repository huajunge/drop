...
public class List_your_space extends Activity {
	...
	String image1,resize,weeklyedit,monthlyedit,currencycode1;
	 int tit_step=0, sum_step=0, photo_step=0, add_step=0, pri_step=0,chk;
	 String listpay;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		System.out.println("sri" +image1);
		image_id=image1;
		//resize=i.getStringExtra("resize");
		imaage=i.getStringExtra("image");		
		System.out.println("image in list ur space  "+imaage);		
		...
		gettext=text;
		System.out.println("getsummary ===="+gettext);
		text1=i.getStringExtra("text1");
		getsummary=text1;
	    System.out.println("getsummary ===="+getsummary);
		

		
		System.out.println("summary in listyour space"+dis1);
		
		System.out.println("city in list your space"+city);
		System.out.println("state in list your space"+state);
		System.out.println("country in list your space "+country1);
		System.out.println("Address in list your space"+address1);
		
		
		System.out.println("name in  list your space"+name);
		System.out.println("image in list your space"+imaage);
		...
		System.out.println("userid in shared preferences in list your  page  "+userid);
		System.out.println("room id in list your space"+roomid);
		...
		else if  (imaage!=null && imaage.equals(""))
		{
		...
		preview.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//new ProgressTask(List_your_space.this).execute();
				// List_your_space.this.pDialog = ProgressDialog.show(List_your_space.this, "", "Loading Data...",true);
	       pDialog=new ProgressDialog(List_your_space.this);
	            pDialog.show();
		...
		optional.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent optional=new Intent(List_your_space.this,Optional_details.class);	
				System.out.println("room id in optional intent"+roomid);
				...
				optional.putExtra("weeklyedit",weeklyedit);				
				optional.putExtra("monthlyedit", monthlyedit);
				optional.putExtra("currenycode",currencycode1);
		...
		display.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent im=new Intent(List_your_space.this,Multiimage.class);
				
				im.putExtra("image1",image1);
				System.out.println("multiimage" +image1);
				...
				im.putExtra("latitude", latitude1);
				im.putExtra("longitude",longitude1);
				im.putExtra("step",step);
				im.putExtra("check",check);
				Bundle bndlanimation =ActivityOptions.makeCustomAnimation(List_your_space.this, R.anim.trans_left_in,R.anim.trans_left_out).toBundle();
		...
		display1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent tit=new Intent(List_your_space.this,Writetitle.class);
				...
				tit.putExtra("latitude", latitude1);
				tit.putExtra("longitude",longitude1);
		...
		display2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent sum=new Intent(List_your_space.this,Writesummary.class);
				...
				sum.putExtra("latitude", latitude1);
				sum.putExtra("longitude",longitude1);
		...
		display3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent pri=new Intent(List_your_space.this,Writeprice.class);
				...
				pri.putExtra("latitude", latitude1);
				pri.putExtra("longitude",longitude1);
		...
		display4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent add=new Intent(List_your_space.this,Writeaddress.class);
				...
				add.putExtra("latitude", latitude1);
				add.putExtra("longitude",longitude1);
		...
		completeprofile.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO Auto-generated method stub
                Toast.makeText(getApplicationContext(), "List added successfully and Go To YourListing", Toast.LENGTH_LONG).show();
               
				call_webservice1();
				
				Intent back=new Intent(List_your_space.this,Swipe_tabshost.class);
...
*/
		...
		if(dis2!=null && !dis2.equals("0") && !dis2.equals(""))
		{
		...
		else if (dis2!=null && (dis2.equals("0") || dis2.equals("")))
		{
		...
		System.out.println("user id in list your space"+userid);
		...
		back.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
              /*  Toast.makeText(getApplicationContext(), "Your Listing is Incomplete", Toast.LENGTH_SHORT).show();*/
		...
		//tit_step=0, sum_step=0, photo_step=0, add_step=0, pri_step=0,
		System.out.println("tit_step"+tit_step);
		System.out.println("sum_step"+sum_step);
		System.out.println("photo_step"+photo_step);
		System.out.println("add_step"+add_step);
		System.out.println("pri_step"+pri_step);
	 ...
	 {
		  /*
				System.out.println("preview "+dis);
				System.out.println("preview address"+address1);
			   if(dis!=null)
			   {
	      ...
	      System.out.println("after json in preview method"+login_status1);
	      
	      Intent preview=new Intent(List_your_space.this,Detail_page.class);	
			...
			preview.putExtra("addresss",address1);
			preview.putExtra("userid",userid);				
			preview.putExtra("previewstring","2");
			preview.putExtra("latitude", latitude1);
			preview.putExtra("longitude",longitude1);
			preview.putExtra("weeklyedit",weeklyedit);				
			preview.putExtra("monthlyedit", monthlyedit);
			preview.putExtra("currenycode",currencycode1);
...
AppController.getInstance().addToRequestQueue(movieReq);*/
		  ...
		  if(dis!=null)
		   ...
		   if(country1!=null)
		   {
			   country1=country1.replaceAll(" ","%20"); 
		   }
		   
		   if(listpay!=null)
		   {
			   listpay=listpay.replaceAll(" ","%20"); 
		   }
			...
			/*if (total==0 && check!=null)
			{
				if (total==0 && check.equals("1"))
				{
				chk=1; 	
				}
				else if (total==0 && check.equals("0"))
				{
					chk=0;
				}
			}
			else if (total==0 && check==null)
			{
				chk=1;
			}*/
		      	...
		      	final String url=Liveurl+"rooms/add_room?roomid="+roomid+"&user_id="+userid+"&image="+imaage+"&image_id="+image1+"&title="+dis+"&description="+dis1+"&price="+dis2+"&address="+address1+"&title_step="+tit_step+"&summary_step="+sum_step+"&price_step="+pri_step+"&addphoto_step="+photo_step+"&address_step="+add_step+"&currency=USD"+"&latitude="+latitude1+"&longitude="+longitude1+"&country="+country1+"&state="+state+"&city="+city+"&listpay="+listpay+"&step_status="+total+"&check_status_count="+chk;		      	
		      	//"&city="+city+"&state="+state+"&country="+country1+"&latitude="+latitude1+"&longitude="+longitude1+
		      	//"&list_pay="+listpay+
            	//+"&check_status_count="+chk
		      	System.out.println("imaage is"+imaage);
		      	System.out.println("imaage1 is"+image1);
		        /*final String url=Liveurl+"rooms/add_room?roomid="+roomid+"&user_id="+userid+"&image="+imaage+"&image_id="+image1+"&title="+dis+"&description="+dis1+"&price="+dis2+"&address="+address1+"&city="+city+"&state="+state+"&country="+country+"&latitude="+latitude1+"&longitude="+longitude1+"&title_step="+tit_step;*/
		        System.out.println("tit_step"+tit_step);
		        System.out.println("sum_step"+sum_step);
		        System.out.println("pri_step"+pri_step);
		        System.out.println("photo_step"+photo_step);
	 ...
	 public void call_webservice1()
	 {
	      ...
	      System.out.println("after json"+login_status);
	             ...
	             if(login_status1.matches("List updated successfully"))
	             {
	                 ...
	                 /*Toast.makeText(getApplicationContext(), "List added  Successfully", Toast.LENGTH_SHORT).show();*/
	                  Intent i1 = new Intent(List_your_space.this, Swipe_tabshost.class);
	 ...
	 public void call_webservice3()
	 {
		  ...
		  if(dis!=null)
		   ...
		   if(address1!=null)
		   {
			   address1=address1.replaceAll(" ","%20");
		        ...
		        chk=0;   	
		      	final String url=Liveurl+"rooms/add_room?roomid="+roomid+"&user_id="+userid+"&image="+imaage+"&image_id="+image1+"&title="+dis+"&description="+dis1+"&price="+dis2+"&address="+address1+"&city="+city+"&state="+state+"&country="+country1+"&latitude="+latitude1+"&longitude="+longitude1+"&title_step="+tit_step+"&summary_step="+sum_step+"&price_step="+pri_step+"&addphoto_step="+photo_step+"&address_step="+add_step+"&check_status_count="+chk+"&currency=USD";	
				System.out.println("URL is"+url);
				 // Creating volley request obj
				JsonArrayRequest movieReq = new JsonArrayRequest(url,
						new Response.Listener<JSONArray>() {
	      ...
	      System.out.println("after json"+login_status);
	             ...
	             if(login_status1.matches("List updated successfully"))
	             {
	                 ...
	                 Toast.makeText(getApplicationContext(), "List added  Successfully", Toast.LENGTH_SHORT).show();
	                  Intent i1 = new Intent(List_your_space.this, Swipe_tabs.class);
	                  i1.putExtra("userid",userid);
	                  i1.putExtra("roomid",roomid);
	                   // Bundle bndlanimation =ActivityOptions.makeCustomAnimation(getApplicationContext(), R.anim.trans_left_in,R.anim.trans_left_out).toBundle();
	                    startActivity(i1);
