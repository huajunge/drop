...
import info.androidhive.customlistviewvolley.adater.CustomInboxTravelAdapter;
...
public class TravelInboxFragment extends Fragment implements IXListViewListener {
	
	private static final String TAG = Swipe_tabs.class.getSimpleName();
	Bitmap edbitmap;
	Bitmap edbitmap1;
	private CustomInboxTravelAdapter adapter;
	 String Liveurl="";
	 URL Login_Url;
	...
	/* 	static Inbox init(int val) {
		 ...
		 return truitonFrag;
	 	 ...
	 	 @Override
		    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		        ...
		        View inbox = inflater.inflate(R.layout.inbox_listview, container, false);
      ...
      Liveurl = sharedPreferences.getString("liveurl", null);
		...
		/*back.setOnClickListener(new View.OnClickListener() {
	       ...
	       listView = (XListView)inbox.findViewById(R.id.listView5);
	       explore=(Button)inbox.findViewById(R.id.button1);
	       bg_img=(ImageView)inbox.findViewById(R.id.imageView1);
	       
	       layout=(RelativeLayout)inbox.findViewById(R.id.relativeLayout1);
	       text3=(TextView)inbox.findViewById(R.id.textView3);
	       text4=(TextView)inbox.findViewById(R.id.textView4);
	       text1=(TextView)inbox.findViewById(R.id.textView1);
	       
	       
	       viewPager = (ViewPager) getActivity().findViewById(R.id.pager);

			adapter = new CustomInboxTravelAdapter(getActivity(), movieList);
	       ...
	       final String url=Liveurl+"payment/guest_inbox?userto="+userid+"&start="+start;
	//*******************************************ListView code start*****************************************************
...
public class TravelInboxFragment extends Fragment {
