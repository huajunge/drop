...
import info.androidhive.customlistviewvolley.adater.CustomMyTripsPreviousAdapter;
...
public class PreviousFragment extends Fragment implements IXListViewListener {
	
	private static final String TAG = Swipe_tabs.class.getSimpleName();
	Bitmap edbitmap;
	Bitmap edbitmap1;
	private CustomMyTripsPreviousAdapter adapter;
	 String Liveurl="";
	 URL Login_Url;
	...
	/* 	static Inbox init(int val) {
		 ...
		 return truitonFrag;
	 	 ...
	 	 @Override
		    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		        ...
		        View previous = inflater.inflate(R.layout.fragment_layout, container, false);
		        beforelogin = (RelativeLayout) previous.findViewById(R.id.beforelogin);
		        explore=(Button)previous.findViewById(R.id.button1);
      ...
      Liveurl = sharedPreferences.getString("liveurl", null);
		...
		/*back.setOnClickListener(new View.OnClickListener() {
	       ...
	       listView = (XListView)previous.findViewById(R.id.listView5);
	       ...
	       if(currency1==null)
			...
			adapter = new CustomMyTripsPreviousAdapter(getActivity(), movieList);
		...
		/*	if(userid=="null"||userid==null)
	     ...
	     hidePDialog();
	       ...
	       final String url=Liveurl+"rooms/previoustrips?user_id="+userid+"&start="+start+"&common_currency="+currency1;
	//*******************************************ListView code start*****************************************************
										...
										public void onResponse(JSONArray response) {
											...
											for (int i = 0; i < response.length(); i++) {
												try {
													...
													if(login_status.matches("No Data Found"))
													{
														Toast.makeText(getActivity(), "No more Previous Trips",Toast.LENGTH_SHORT).show();
														listView.stopLoadMore();
														listView.hide();
													...
													//movie.getuserby(obj.getString("userby"));
													//movie.getid(obj.getString("reservation_id"));
