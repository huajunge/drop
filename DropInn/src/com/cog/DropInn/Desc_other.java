...
public class Desc_other extends Activity {
	String ga,sp,gu,gi,no,ot,dis5;
	EditText other;
	ImageView done;
	String userid,dis,dis11,dis22,imaage,address1,city,state,country,room_id,image1,resize,getother,d_other,getrules;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_desc_other);
		getActionBar().hide();
		other=(EditText)findViewById(R.id.editText1);		
		...
		other.setSelection(other.getText().length());
		...
		longitude1=i.getStringExtra("longitude");
		   ...
		   SharedPreferences sharedPreferences2 = PreferenceManager.getDefaultSharedPreferences(this);
			...
			public void onClick(View v) {
				...
				Intent back=new Intent(Desc_other.this,Writedescription.class);
				Bundle bndlanimation =ActivityOptions.makeCustomAnimation(Desc_other.this, R.anim.trans_right_in,R.anim.trans_right_out).toBundle();
