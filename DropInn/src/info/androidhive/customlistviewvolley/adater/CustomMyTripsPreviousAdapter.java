...
import com.cog.DropInn.Previousdetails;
import com.cog.DropInn.R;

public class CustomMyTripsPreviousAdapter extends BaseAdapter {
	...
	public CustomMyTripsPreviousAdapter(Activity activity, List<Movie> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.mytrips_previous,parent,false);
				...
				country.setText(addr);
				  ...
				  thumbNail.setOnClickListener(new View.OnClickListener() {
			            ...
			            public void onClick(View view) {
			            	...
			            	Intent search=new Intent(activity,Previousdetails.class);
