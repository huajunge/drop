...
public class CustomMyTripsUpcomingAdapter extends BaseAdapter {
	...
	public CustomMyTripsUpcomingAdapter(Activity activity, List<Movie> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.mytrips_upcoming,parent,false);
		...
		final String india2 = money.format(new Double(m.getprice()));
		 price.setText(india2);		
			//country	
				...
				System.out.println("statusssssssssssssssssssssssssss" +m.tripstatus());
				  ...
				  thumbNail.setOnClickListener(new View.OnClickListener() {
			            ...
			            public void onClick(View view) {
			            	...
			            	Intent search=new Intent(activity,Upcomingdetails.class);
